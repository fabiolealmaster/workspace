...
public static void main(String[] args) {
       ...
       if(palavrafiltrada.equals(palavraInvertida)) 
            JOptionPane.showMessageDialog(null,palavra + " É uma palavra/frase palindroma"); 
       else 
            JOptionPane.showMessageDialog(null,palavra + " Não é uma palavra/frase palindroma"); 
